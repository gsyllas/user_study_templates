...
var defComparePage = {
    ...
    questions: [
        ...
        },
        {
            type: "rating",
            name: "question2-",
            title: "Παρακαλώ συγκρίνετε τις 2 προτάσεις, και βαθμολογήσετε την ομοιότητα του ομιλητή στα δύο ηχητικά:",
            isRequired: true,
            rateMin: 1,
            rateMax: 5,
            rateStep: 1,
